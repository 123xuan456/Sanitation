 ...
 * 处理多选的照片
 */
public class GridImagesAdapter extends
        RecyclerView.Adapter<GridImagesAdapter.ViewHolder> {
    ...
    public GridImagesAdapter(Activity context, onAddPicClickListener mOnAddPicClickListener) {
            ...
            if (mItemClickListener != null) {
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (list.size() > 0) {
                            //预览图片
                            PictureSelector.create(context).externalPicturePreview(adapterPosition, list);
                        }
