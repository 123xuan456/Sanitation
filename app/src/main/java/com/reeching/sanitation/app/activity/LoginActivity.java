...
import com.reeching.sanitation.mvp.presenter.ILoginPresenter;
import com.reeching.sanitation.mvp.presenter.LoginComp;
...
public class LoginActivity extends FragmentActivity implements View.OnClickListener ,ILoginView {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (!TextUtils.isEmpty(roleName)){
            openAct(LoginActivity.this,HomeActivity.class);
            finish();
        }
    ...
    private void initView() {
        ...
        loginPresenter=new LoginComp(this);
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.iv_show_pwd:
                ...
                break;
            case R.id.btn_login:
                loginPresenter.Login(et_mobile.getText().toString(), et_password.getText().toString());
                break;
        }
    }
    @Override
