...
public class WillStreetListRecycleAdapter extends CommonBaseRecycleAdapter<StreetListBean.InfosBean> {
    boolean isChannel;
    public WillStreetListRecycleAdapter(Context context, List<StreetListBean.InfosBean> datas, boolean isOpenLoadMore,boolean isChannel) {
    ...
    protected void convert(ViewHolder holder, final StreetListBean.InfosBean data, final int position) {
        ...
        holder.setText(R.id.textView4,data.getFieldTeamName());//所属场对
        holder.setText(R.id.textView2,data.getStreetSegment());//道路分段
        holder.setText(R.id.textView8,data.getStreetStart());//路段起点
        holder.setText(R.id.textView16,data.getStreetEnd());//路段止点
    ...
    protected int getItemLayoutId() {
        return R.layout.item_street_layout;
    }
